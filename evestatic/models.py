...
class MapDenormalize(models.Model):
    ...
    solarsystem = models.ForeignKey(SolarSystem, null=True)
    constellation = models.ForeignKey(Constellation, null=True)
    region = models.ForeignKey(Region, null=True)
    orbit = models.ForeignKey('self', null=True)
    celestial_index = models.IntegerField(null=True)
    orbit_index = models.IntegerField(null=True)
